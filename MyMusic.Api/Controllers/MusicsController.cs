...
namespace MyMusic.Api.Controllers
{
    ...
    public class MusicsController : ControllerBase
    {
        ...
        //method called GetAllMusics that is public, asynchronous 
        //and returns a Task<ActionResult<IEnumerable<MusicResource>>>
        [HttpGet("")]
        ...
        //[FromBody] attribute before the parameter, it indicates that this object is coming from the requests body
        [HttpPost("")]
